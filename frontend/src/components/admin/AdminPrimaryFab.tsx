...
export default function AdminPrimaryFab() {
  ...
  return (
    <div
      ref={rootRef}
      className={cn(
        'fixed bottom-[max(1rem,env(safe-area-inset-bottom))] right-[max(1rem,env(safe-area-inset-right))] z-[80] lg:hidden',
      )}
    >
      <AnimatePresence>
        {open && (
          ...
          >
            <button
              ...
              className="flex w-full items-center gap-3 px-4 py-3 text-[13px] font-bold text-foreground transition-colors hover:bg-muted"
            >
