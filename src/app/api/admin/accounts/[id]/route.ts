...
const updateAccountSchema = z.object({
  ...
  socialPostCount: z.coerce.number().int().min(0).optional(),
  opposedPosts: z.coerce.number().int().min(0).optional(),
  aiFlaggedPosts: z.coerce.number().int().min(0).optional(),
  disputedPosts: z.coerce.number().int().min(0).optional(),
  disputesLost: z.coerce.number().int().min(0).optional(),
});
