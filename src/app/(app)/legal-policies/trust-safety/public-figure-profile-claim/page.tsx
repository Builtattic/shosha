...
export default function PublicFigureProfileClaimPage() {
  const content = getPolicyContent('trust-safety', 'public-figure-profile-claim');
      ...
      <div className="mx-auto max-w-2xl px-4 pt-5 pb-[calc(5.5rem+env(safe-area-inset-bottom))]">
        ...
        <div className="mb-6">
          ...
          <h1 className="font-serif text-[28px] font-black leading-none tracking-tight text-foreground">
            Public Figure & Profile Claim Policy
          </h1>
          <p className="mt-1.5 text-[13px] text-muted-foreground">
            Who can claim a profile, what evidence is required, and how disputes are resolved.
          </p>
        </div>
