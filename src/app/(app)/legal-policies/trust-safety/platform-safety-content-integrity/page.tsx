...
export default function PlatformSafetyContentIntegrityPage() {
  const content = getPolicyContent('trust-safety', 'platform-safety-content-integrity');
      ...
      <div className="mx-auto max-w-2xl px-4 pt-5 pb-[calc(5.5rem+env(safe-area-inset-bottom))]">
        ...
        <div className="mb-6">
          ...
          <h1 className="font-serif text-[28px] font-black leading-none tracking-tight text-foreground">
            Platform Safety & Content Integrity Policy
          </h1>
          <p className="mt-1.5 text-[13px] text-muted-foreground">
            How Shosha detects, reviews, and acts on harmful or misleading content.
          </p>
        </div>
