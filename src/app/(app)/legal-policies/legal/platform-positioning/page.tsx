...
export default function PlatformPositioningPage() {
  const content = getPolicyContent('legal', 'platform-positioning');
      ...
      <div className="mx-auto max-w-2xl px-4 pt-5 pb-[calc(5.5rem+env(safe-area-inset-bottom))]">
        ...
        <div className="mb-6">
          ...
          <h1 className="font-serif text-[28px] font-black leading-none tracking-tight text-foreground">
            Shosha Platform Positioning
          </h1>
          <p className="mt-1.5 text-[13px] text-muted-foreground">
            What Shosha is, what it is not, and how it fits within the broader information ecosystem.
          </p>
        </div>
